...
-- Dropping in reverse dependency order; the extension is left in place because other
-- migrations (and other services sharing the instance) may still rely on it.
